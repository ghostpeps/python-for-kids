...
st.write("A backslash followed by an ASCII octal escape sequence will result in an ASCII symbol.\nGo to [ASCII table](%s)" % url1 + " for a full list of ASCII code. Look at an example:")
st.code(body=r"""
print("\41")
print("\207")
print("\275")
